function App() {
  return (
    ...
    <div className="flex flex-wrap w-screen h-screen relative">
      ...
      <h1 className="capitalize font-bold text-white absolute left-1/2 top-1/2 z-20 -translate-x-1/2 -translate-y-1/2 px-6 text-[8vw] sm:text-[7vw] lg:text-[5vw] 4k:text-[6vw] w-full text-center">¡¡we are comming soon!!</h1>
